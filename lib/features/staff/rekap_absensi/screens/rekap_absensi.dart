...
class StaffRekapAbsensi extends StatefulWidget {
  const StaffRekapAbsensi({super.key});

  @override
  State<StaffRekapAbsensi> createState() => _RekapAbsensiState();
}

class _RekapAbsensiState extends State<StaffRekapAbsensi> {
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var rekap =
          Provider.of<StaffRekapAbsensiController>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    StaffRekapAbsensiController rekap =
        Provider.of<StaffRekapAbsensiController>(context);
                        ...
                        rekap.selectedMonth != ''
                            ? DecoratedBox(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      right: 10, left: 20),
                                  child: Consumer<StaffRekapAbsensiController>(
                                      builder: (BuildContext context,
                                          StaffRekapAbsensiController rekap,
                                          Widget? child) {
                                    return DropdownButton<String>(
