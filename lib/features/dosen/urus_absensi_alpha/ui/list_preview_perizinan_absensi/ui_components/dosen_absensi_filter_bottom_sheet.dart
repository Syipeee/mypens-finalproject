...
class DosenAbsensiFilterBottomSheet extends StatelessWidget {
  final DosenListPerizinanAbsensiViewModel viewModel;
  const DosenAbsensiFilterBottomSheet({
            ...
            children: [
              ...
              LabeledWidget(
                ...
                child: DropdownButtonFormField(
                  ...
                  onChanged: (year){
                    if (year != null) {
                      viewModel.add(OnChangeTahunAjaranFilter(year));
                    }
                  },
              ...
              LabeledWidget(
                ...
                child: DropdownButtonFormField(
                  ...
                  onChanged: (semester){
                    if (semester != null){
                      viewModel.add(OnChangeSemesterFilter(semester));
                    }
                  },
                  decoration: MyOutlinedInputDecoration(),
              ...
              LabeledWidget(
                ...
                child: DropdownButtonFormField(
                  ...
                  onChanged: (status){
                    viewModel.add(OnChangeStatusPenerimaanFilter(status));
                  },
                  decoration: MyOutlinedInputDecoration(),
          ...
          child: FilledButton(
            ...
            onPressed: (){
              ...
              Navigator.of(context).popUntil(
                      (route) =>
                  route.settings.name == MyPensNavRoutes
                    .dosenListPerizinanAbsensi
              );
            },
