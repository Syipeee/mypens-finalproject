...
class RevisiSidangTesis extends StatefulWidget {
  const RevisiSidangTesis({Key? key}) : super(key: key);

  @override
  _RevisiSidangTesisState createState() => _RevisiSidangTesisState();
}

class _RevisiSidangTesisState extends State<RevisiSidangTesis> {
  @override
  void initState() {
    super.initState();
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var revisi =
          Provider.of<RevisiSidangTesisController>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    RevisiSidangTesisController revisi =
        Provider.of<RevisiSidangTesisController>(context);
    ...
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        title: const Text('Revisi Sidang Tesis'),
                            ...
                            ? DecoratedBox(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      right: 10, left: 20),
                                  child: Consumer<RevisiSidangTesisController>(
