...
class _DataKegiatanState extends State<DataKegiatan> {
  ...
  void initState() {
    super.initState();
    Provider.of<KegiatanProvider>(context, listen: false).fetchKegiatans();
  }
    ...
    return Scaffold(
      ...
      body: Consumer<KegiatanProvider>(
        builder: (context, kegiatanProvider, child) {
          ...
          } if (kegiatanProvider.kegiatans.isEmpty) {
            return Center(child: Text('Refresh Ulang Halaman'));
          } else {
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return DetailKegiatan(kegiatan: kegiatan);
                    }));
                  },
                  child: Padding(
