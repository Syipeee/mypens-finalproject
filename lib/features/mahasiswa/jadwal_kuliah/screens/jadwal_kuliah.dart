...
class _JadwalKuliahState extends State<JadwalKuliah> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var jadwalKuliah =
          Provider.of<JadwalKuliahController>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    JadwalKuliahController jadwalKuliah =
        Provider.of<JadwalKuliahController>(context);
                                  ...
                                  ? DecoratedBox(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.only(
                                            right: 10, left: 20),
                                        child: Consumer<JadwalKuliahController>(
                                            builder: (BuildContext context,
                                                JadwalKuliahController nilai,
                                                Widget? child) {
