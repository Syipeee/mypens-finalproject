...
import '../../features/mahasiswa/nilai_per_semester/services/nilai_per_semester.dart';
import '../../../../constants/url.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class NilaiPerSemesterController extends ChangeNotifier {
  NilaiPerSemesterController(this.userId);
  ...
  void getDaftarNilai() async {
    ...
    try {
      ...
      final nilaiPerSemester = nilaiPerSemesterFromJson(response.body);
      daftarNilai = nilaiPerSemester;
      hasError = "";
      isLoading = false;
      notifyListeners();
    } catch (e) {
